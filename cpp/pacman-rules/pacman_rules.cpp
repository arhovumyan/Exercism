...
bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
    ...
    if (power_pellet_active && touching_ghost == true) return true; 
    return false;
}
...
bool scored(bool touching_power_pellet, bool touching_dot) {
    ...
    if (touching_power_pellet || touching_dot == true) return true;
    return false;
}
...
bool lost(bool power_pellet_active, bool touching_ghost) {
    ...
    if (power_pellet_active == false && touching_ghost == true) return true;
    return false;
}
...
bool won(bool has_eaten_all_dots, bool power_pellet_active,
    ...
    if (has_eaten_all_dots == true && lost(power_pellet_active, touching_ghost) == false) return true;
    return false;
}
