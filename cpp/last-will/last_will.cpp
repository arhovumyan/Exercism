...
int assemble_code(int numbers){
    int zhangFragment = zhang::red::code_fragment() + zhang::blue::code_fragment();
    int khan_fragment = khan::red::code_fragment() + khan::blue::code_fragment();
    int garciaFragment = garcia::red::code_fragment() + garcia::blue::code_fragment();
    return zhangFragment + khan_fragment + garciaFragment;
}
}